...
namespace ITMLib
{
	namespace Engine
	{
		...
		public:
			...
			virtual void GradientX(ITMFloatImage *grad_out, const ITMFloatImage *depth_in) const = 0;
			virtual void GradientY(ITMFloatImage *grad_out, const ITMFloatImage *depth_in) const = 0;
