...
try
{
	...
	else
	{
		...
		else
		{
			...
			//imageSource = new RawFileReader(calibFile, imagesource_part1, imagesource_part2, Vector2i(640, 480), 1.0f, Vector2i(320, 240), 0.5f);
			imageSource = new RawFileReader(calibFile, imagesource_part1, imagesource_part2, Vector2i(640, 480), 1.0f, Vector2i(640, 480), 1.0f);
